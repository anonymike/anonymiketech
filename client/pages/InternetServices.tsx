            ...
            >
              ...
              >
                <div className="glow-border rounded-lg p-6 bg-gradient-to-r from-hacker-terminal/80 to-hacker-green/20 backdrop-blur-sm animate-glow-pulse max-w-2xl mx-auto">
                  ...
                  >
                    🔥 FRESH WEEK VPN PRICES! 🔥
                  </motion.h3>
                  <p className="text-lg text-hacker-green animate-flicker">
                    Exclusive pricing available Stay tuned for amazing offers!
                  </p>

                  {/* Countdown Timer for Weekend/Special Offers */}
                  <div className="mt-4">
                    <CountdownTimer />
                  </div>
                  ...
                  >
                    🚀 Get ready! Amazing deals dropping soon - be the first to grab them!
                  </motion.div>
                </div>
              </motion.div>
            </motion.div>
