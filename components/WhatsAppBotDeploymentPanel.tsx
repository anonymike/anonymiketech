...
import TruthMdSessionImporter from './TruthMdSessionImporter'
    ...
    >
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Choose your deployment method or use TRUTH MD session
        </p>
      </div>
      ...
      <Tabs defaultValue="standard" className="w-full">
        <TabsList className="grid w-full grid-cols-2">
          ...
          <TabsTrigger value="truth-md">TRUTH MD Session</TabsTrigger>
        </TabsList>

        {/* TRUTH MD Tab */}
        <TabsContent value="truth-md" className="space-y-4 mt-4">
